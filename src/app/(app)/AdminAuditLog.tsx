...
export default function AdminAuditLog() {
  ...
  const [filter, setFilter]     = useState<'all' | 'ai_call' | 'error' | 'login'>('all')
  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-5 gap-3 mb-6">
        {[
          { label: '🔐 Logins',         value: logs.filter(l => l.action_type === 'login').length, color: 'text-accent2 bg-accent2/10 border-accent2/20' },
        ...
        <>
          ...
          <div className="flex gap-3 mb-4 flex-wrap">
            ...
            <div className="flex gap-1 p-1 bg-surface2 rounded-xl">
              {([['all','All'],['login','Logins'],['ai_call','AI Calls'],['error','Errors']] as const).map(([f, label]) => (
