...
export function DeveloperAssetsCard({ workspace }: { workspace: CorporateWorkspace }) {
  ...
  function downloadAll() {
    ASSETS.forEach((a, i) => setTimeout(() => {
      window.location.href = `/api/corporate/assets/dockerfile?file=${a.type}`
    }, i * 250))
    markStepDone()
  }

  return (
    <div id="deployment-assets" className="bg-white rounded-2xl border border-slate-200/80 p-6 transition-all">
